...
echo "Starting PPO training and evaluation on BipedalWalker-v3..."
...
print("PPO BipedalWalker | Test-time = Train-time constraint [-1, 1]")
evaluate_sb3(
    PPO,
...
print("PPO BipedalWalker | Test-time constraint [-0.8, 0.8]")
evaluate_sb3(
    PPO,
    model_path='info/models/BipedalWalker-v3_PPO_min-1_max1.zip',
    env_id='BipedalWalker-v3',
