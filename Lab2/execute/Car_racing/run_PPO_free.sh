...
echo "Starting PPO training and evaluation on CarRacing-v3..."
...
print("PPO CarRacing | Test-time = Train-time constraint [-1, 1]")
evaluate_sb3(
    PPO,
...
print("PPO CarRacing | Test-time constraint [-0.8, 0.8]")
evaluate_sb3(
    PPO,
    model_path='info/models/CarRacing-v3_PPO_min-1_max1.zip',
    env_id='CarRacing-v3',
